...
export const removeTodolistTC = createAppAsyncThunk('todolists/removeTodolist', async (todolistId: string, thunkAPI) => {
...
export const changeTodolistTitleTC = createAppAsyncThunk('todolists/changeTodolistTitle', async (param: {todolistId: string, title: string}, thunkAPI) => {
